...
use App\Repository\DocumentPercepcionRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=DocumentPercepcionRepository::class)
 */
class DocumentPercepcion
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Document::class, inversedBy="percepciones")
     * @ORM\JoinColumn(nullable=false)
     */
    private $document;
