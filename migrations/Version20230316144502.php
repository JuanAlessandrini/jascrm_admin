 ...
 */
final class Version20230316144502 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document_detail (id INT AUTO_INCREMENT NOT NULL, concepto_id INT NOT NULL, ammount NUMERIC(15, 2) NOT NULL, INDEX IDX_9064CEF56C2330BD (concepto_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE document_sub_cuenta (document_id INT NOT NULL, sub_cuenta_id INT NOT NULL, INDEX IDX_22555BD5C33F7837 (document_id), INDEX IDX_22555BD588E2B7A6 (sub_cuenta_id), PRIMARY KEY(document_id, sub_cuenta_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
